...
const DeliveryTransactions = ({ sales, updateStatus }) => {
  ...
  const [csvMessage, setCsvMessage] = useState(""); // ✅ CSV toast
...
const filteredSales = useMemo(() => {
  ...
  return salesData
    ...
    .filter((s) => {
      ...
      const toTime = toDate ? new Date(toDate).getTime() + 86399999 : null; // include entire day
      return (!fromTime || itemTime >= fromTime) && (!toTime || itemTime <= toTime);
    });
