...
//         <p className="font-semibold text-sm text-sky-400">
...
//             {msg.type === "text" && (
//               <div
//                 className={`px-3 py-1.5 rounded-xl text-sm whitespace-pre-wrap break-words ${
//                   msg.from === "admin"
...
//           className="flex-1 bg-neutral-700 rounded-full px-3 py-1.5 text-sm outline-none"
//         />
//         <button
...
//         {/* Sticker Panel */}
//         {showStickers && (
//           <div className="absolute bottom-14 left-0 bg-neutral-900 border border-neutral-700 p-3 rounded-2xl shadow-lg w-64">
  ...
  <div ref={messagesEndRef} />
        ...
        <div className="mt-2 flex gap-2 items-end relative">
          ...
          <textarea
            ...
            className="flex-1 bg-neutral-700 rounded-2xl px-3 py-1.5 text-sm text-white outline-none resize-none max-h-28 overflow-y-auto"
          />
