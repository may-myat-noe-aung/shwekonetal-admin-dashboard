...
//   //     const buyData = [];
//   //     for (const [date, times] of Object.entries(buyRes.data)) {
//   //       for (const [time, price] of Object.entries(times)) {
//   //         if (price !== null) {
//   //           buyData.push({
//   //             time: `${date} ${time}`, // or just time if you want
//   //             buy: price,
//   //           });
//   //         }
//   //       }
...
//   //     const sellData = [];
//   //     for (const [date, times] of Object.entries(sellRes.data)) {
//   //       for (const [time, price] of Object.entries(times)) {
//   //         if (price !== null) {
//   //           sellData.push({
//   //             time: ` ${time}`,
...
//     // Get first object (today)
//     const firstBuyDate = Object.keys(buyRes.data)[0];
//     const firstSellDate = Object.keys(sellRes.data)[0];
//     console.log(firstBuyDate, firstSellDate);

//     const buyData = [];
//     for (const [time, price] of Object.entries(buyRes.data[firstBuyDate])) {
//       if (price !== null) {
//         buyData.push({
//           time: `${time}`,
//           buy: price,
...
//     const sellData = [];
//     for (const [time, price] of Object.entries(sellRes.data[firstSellDate])) {
//       if (price !== null) {
//         sellData.push({
//           time: `${time}`,
//           sell: price,
...
//         { passcode: password } // passcode can be string or int
//       );

//       // Assuming API returns { success: true } on correct passcode
//       if (response.data.success) {
//         startCountdown(modalType); // proceed if correct
//       } else {
