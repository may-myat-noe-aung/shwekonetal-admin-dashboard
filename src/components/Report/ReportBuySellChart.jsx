...
//           date: item[0],
//           buyGold: item[1],   // changed from buy → buyGold
//           sellGold: item[2],  // changed from sell → sellGold
//         }));
...
//       <h3 className="font-semibold mb-2 text-yellow-400">Buy Gold vs Sell Gold Trend</h3>
//       <div className="h-64">
...
//             />
//             <Area type="monotone" dataKey="buyGold" stroke="#22c55e" fill="url(#gBuyGold)" />
//             <Area type="monotone" dataKey="sellGold" stroke="#ef4444" fill="url(#gSellGold)" />
//           </AreaChart>
//         </ResponsiveContainer>
//       </div>
//     </div>
